...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../.symlinks/plugins/flutter_alibc/ios/Resources/backbutton@2x.png"
  install_resource "${PODS_ROOT}/../.symlinks/plugins/flutter_alibc/ios/Resources/backbutton@3x.png"
fi
